...
$("#btnLogin").on("click", e =>{
  ...
  var promise = auth.signInWithEmailAndPassword(email, pass).then(() => {
    M.toast({html: "Iniciando Sesión", displayLength: 3000, classes: "light-blue"})
  })
...
ref.on("child_changed",  function(snapshot) {
  ...
  M.toast({html: 'Los Profesores están agregando notas', displayLength: 4000, classes: 'light-blue lighten-3'})
  $("body").html("")
  $("tbody").html("")
})
// ----------------------- Logout --------------------------------------
